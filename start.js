const pictures = document.querySelectorAll('.Picture');// animation moving pictures
var previousTouch = undefined;

function updateElementPosition(element, event) {
  var movementX, movementY;

  if (event.type === 'touchmove') {// animation moving pictures
...
function startDrag(element, event) {// animation moving pictures
